  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col items-center gap-6 px-4 py-12">
      <div className="text-center">
        <h1 className="text-2xl font-semibold text-slate-900">Load your TA extract</h1>
      ...
      >
        <div className="text-base font-medium text-slate-700">Drop your .xlsx or .csv here</div>
      ...
      <div className="mt-4 rounded-lg border border-slate-200 bg-white p-4 text-xs leading-relaxed text-slate-500">
        <strong className="text-slate-700">Privacy:</strong> This is a 100% in-browser tool. There is
